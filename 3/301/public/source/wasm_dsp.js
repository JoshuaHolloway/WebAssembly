...
var Module = typeof WasmDsp !== 'undefined' ? WasmDsp : {};
...
var wasmBinaryFile = 'wasm_dsp.wasm';
...
var _copy_array = Module["_copy_array"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["copy_array"].apply(null, arguments)
};
...
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = WasmDsp;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return WasmDsp; });
    else if (typeof exports === 'object')
      exports["WasmDsp"] = WasmDsp;
