...
-Instead Emscripten uses a few helper functions from the  
 emscripen.h library to execute JS code.
-Emscripten.h can be thought of as being the C-version 
 of preamble.js.

-Create c-file: imports.c:
...
-Update index.html to use load the new WASM via imports.js:

<script src="imports.js"></script>

-npm start and check console in browser.